...
public class AuthRepository : IAuthRepository
{
    ...
    public string GenerateJwtToken(UserAdmin userAdmin)
    {
        
        var claims = new Claim[]
        {
            new Claim(JwtRegisteredClaimNames.Name, userAdmin.nameUser),
            new Claim(JwtRegisteredClaimNames.Email, userAdmin.emailUser),
        };
